...
const translations = {
  fr: {
    ...
    clinicDesc: "En tant que Directeur de la Clinique de Nouadhibou, je combine mes compétences en développement avec ma vision entrepreneuriale pour créer des solutions technologiques innovantes dans le domaine de la santé.",
  ...
  ar: {
    ...
    clinicDirector: "مدير مصحة نواذيبو",
    clinicDesc: "كمدير تنفيذي لمصحة نواذيبو، أجمع بين مهارات التطوير و البرمجة مع رؤيتي للأعمال لإنشاء حلول تكنولوجية مبتكرة في مجال الرعاية الصحية",
  ...
  en: {
    ...
    clinicDirector: "CEO of Clinique De Nouadhibou",
    clinicDesc: "As CEO of Clinique de Nouadhibou, I combine development skills with business vision to create innovative technological solutions in healthcare.",
